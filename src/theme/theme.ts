    ...
    MuiTextField: {
      styleOverrides: {
        root: {
          ...
          '& input': {
            fontSize: '16px', // Asegúrate de que el tamaño de la fuente sea lo suficientemente grande para evitar el zoom en móviles
            touchAction: 'none', // Previene el zoom táctil
          },
        },
      },
    },
